    ...
    with psycopg.connect(DB_URL) as conn:
        ...
        with conn.cursor() as cur:
            ...
            assert {row[0] for row in cur.fetchall()} == {
                ...
                "frontier_append_only_opportunity_anchors_truncate",
                "frontier_append_only_opportunity_memberships",
                "frontier_append_only_opportunity_memberships_truncate",
                "frontier_append_only_opportunity_transitions",
                "frontier_append_only_opportunity_transitions_truncate",
                "frontier_append_only_outcome_resolutions",
                "frontier_append_only_outcome_resolutions_truncate",
