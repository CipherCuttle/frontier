...
export type ExperimentalOverviewResponse = { "analysis_artifacts": Record<string, ExperimentalAnalysisArtifactResponse>; "as_of": string; "as_of_consistency": string; "authority_state"?: string; "availability": Record<string, string>; "candidate_id": string; "configuration_digest": string; "experiment_id": string; "generated_at": string; "interpretation"?: string; "latest_evaluation_receipt": ExperimentalEvaluationReceiptResponse | null; "latest_feature_batch": ExperimentalFeatureBatchResponse | null; "latest_pef_artifact": ExperimentalPefArtifactResponse | null; "latest_shadow_run": ExperimentalShadowRunResponse | null; "schema_version"?: string; };
